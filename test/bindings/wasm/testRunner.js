...
const ignoreFuxxProps = ['id', 'error', 'code', 'registryId', 'lastBlockNumber', 'currentBlock', 'rpcTime', 'rpcCount', 'gasUsed', 'execTime', 'lastNodeList', 'totalDifficulty', 'size', 'chainId', 'transactionLogIndex', 'logIndex', 'lastValidatorChange']

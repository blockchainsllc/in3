...
cmake --graphviz=in3.dot  -DCMAKE_EXPORT_COMPILE_COMMANDS=true -DUSE_CURL=true -DCURL_BLOCKING=true -DIN3_LIB=true -DTEST=true -DUSE_SEGGER_RTT=false -DBUILD_DOC=true -DJAVA=true -DCMAKE_BUILD_TYPE=Debug .. 

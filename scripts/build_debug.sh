...
cmake -DDEBUG=true -DUSE_CURL=true -DCURL_BLOCKING=true -DIN3_LIB=true -DTEST=true -DUSE_SEGGER_RTT=false -DBUILD_DOC=true -DJAVA=true -DCMAKE_BUILD_TYPE=Debug .. -DLIBCURL_TYPE=static && make -j8

...
args=(
 ...
 '-nl[a coma seperated list of urls as address:url to be used as fixed nodelist]:nl:()'
 '-bn[a coma seperated list of urls as address:url to be used as boot nodes]:bn:()'

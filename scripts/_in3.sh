...
'-ns[the type of the signature data]:sigtype:(raw hash eth_sign)'
...
'-kin3[if specified, the response including in3-section is returned]'
...
'--signatures=[add additional signatures, which will be useds when sending through a multisig!]:signatures:()'
'-sigs[add additional signatures, which will be useds when sending through a multisig!]:signatures:()'
'--response-in=[read response from stdin]:response-in:()'
'-ri[read response from stdin]:response-in:()'
'--response-out=[write raw response to stdout]:response-out:()'
'-ro[write raw response to stdout]:response-out:()'

...
class MainNetContractTest(unittest.TestCase):
    ...
    def test_get_storage_at(self):
        storage = self.client.eth.contract.get_storage_at("0x3589d05a1ec4Af9f65b0E5554e645707775Ee43C", 1)
        self.assertEqual(storage, '0x000000000000000000000000000000000000000000000000000000647261676f')

    def test_get_code(self):
        code = self.client.eth.contract.get_code("0x00000000000c2e074ec69a0dfb2997ba6c7d2e1e")
    ...
    def test_abi_encode(self):
        ...
        encoded = self.client.eth.contract.abi_encode(*params)
        ...
        with self.assertRaises(AssertionError):
            self.client.eth.contract.abi_encode(*err0)
        with self.assertRaises(AssertionError):
            self.client.eth.contract.abi_encode(*err1)
        with self.assertRaises(AssertionError):
            self.client.eth.contract.abi_encode(*err2)
    ...
    def test_abi_decode(self):
        ...
        with self.assertRaises(AssertionError):
            self.client.eth.contract.abi_decode(*err0)
        with self.assertRaises(AssertionError):
            self.client.eth.contract.abi_decode(*err1)
        with self.assertRaises(AssertionError):
            self.client.eth.contract.abi_decode(*err2)
        with self.assertRaises(AssertionError):
            self.client.eth.contract.abi_decode(*err3)
        ...
        decoded = self.client.eth.contract.abi_decode(*params)
...
class GoerliContractTest(MainNetContractTest):
    ...
    def test_get_storage_at(self):
        storage = self.client.eth.contract.get_storage_at("0x4B1488B7a6B320d2D721406204aBc3eeAa9AD329", 1)

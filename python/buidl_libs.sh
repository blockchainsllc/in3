...
./build.sh release 3>&1 1>/dev/null 2>&3 3>&- | sed 's/^/   - [!] /' || quit '[e] Error: failed building release.'
...
./build_debug_bindings.sh  3>&1 1>/dev/null 2>&3 3>&- | sed 's/^/   - [!] /' || quit '[e] Error: failed building debug.'

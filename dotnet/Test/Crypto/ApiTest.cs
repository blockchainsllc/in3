...
namespace Test.Crypto
{
    public class ApiTest
    {
        ...
        [Test]
        public async Task Pk2Address()
        {
            string privateKey = "0x0fd65f7da55d811634495754f27ab318a3309e8b4b8a978a50c20a661117435a";

            string address = await in3.Crypto.Pk2Address(privateKey);

            Assert.That(address, Is.EqualTo("0xdc5c4280d8a286f0f9c8f7f55a5a0c67125efcfd"));
        }

        [Test]
        public async Task EcRecover()
        {
            ...
            Account account = await in3.Crypto.EcRecover(msg, signature, SignatureType.Hash);
        ...
        [Test]
        public async Task Sha3()
        {
            string data = "0x68656c6c6f20776f726c64";

            string result = await in3.Crypto.Sha3(data);

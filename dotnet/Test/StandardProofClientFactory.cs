...
namespace Test
{
    public class StandardProofClientFactory : ClientFactory
    {
        public StandardProofClientFactory(Chain chain) : base(chain)
        {
        }
        ...
        protected override void CreateConfig()
        {
            ...
            NodeRegistryConfiguration mainNetConfiguration = clientConfig.NodeRegistry;

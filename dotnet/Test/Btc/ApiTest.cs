...
namespace Test.Btc
{
    public class ApiTest
    {
        ...
        [Test]
        public async Task GetBlockHeaderBytes()
        {
            string[][] mockedResponses =
            {
            ...
            byte[] result = await in3.Btc.GetBlockHeaderBytes("0000000000000000000cd3c5d7638014e78a5fba33be5fa5cb10ef9f03d99e60");
        ...
        [Test]
        public async Task GetBlockWithTxIds()
        {
            string[][] mockedResponses =
            {

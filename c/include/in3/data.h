...
static inline char*    d_get_string(d_token_t* r, char* k) { return d_get_string(r, key(k)); }              /**< reads token of a property as string. */
...
static inline int32_t  d_get_int(d_token_t* r, char* k) { return d_get_int(r, key(k)); }                    /**< reads token of a property as int. */
...
static inline uint64_t d_get_long(d_token_t* r, char* k) { return d_get_long(r, key(k)); }                  /**< reads token of a property as long. */
...
static inline bytes_t* d_get_bytes(d_token_t* r, char* k) { return d_get_bytes(r, key(k)); }                /**< reads token of a property as bytes. */

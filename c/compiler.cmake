...
if (WASM)
  set (CMAKE_C_FLAGS "-Wall  -Wpointer-arith -funsigned-char -Wextra -std=c99 -Wno-unused-function -Wno-null-pointer-arithmetic")
  set (CMAKE_CXX_FLAGS "-Wall -Wpointer-arith -funsigned-char -Wextra  -std=c99 -Wno-unused-function -Wno-null-pointer-arithmetic -D__FILENAME__='\"$(subst ${CMAKE_SOURCE_DIR}/,,$(abspath $<))\"'")

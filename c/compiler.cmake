...
if (WASM)
  set (CMAKE_C_FLAGS "-Wall -funsigned-char -Wextra -std=c99 -Wno-unused-function -Wno-null-pointer-subtraction")
  set (CMAKE_CXX_FLAGS "-Wall -funsigned-char -Wextra  -std=c99 -Wno-unused-function -Wno-null-pointer-subtraction -D__FILENAME__='\"$(subst ${CMAKE_SOURCE_DIR}/,,$(abspath $<))\"'")
...
elseif(WASM)
  ...
  set (CMAKE_C_FLAGS "${CMAKE_CXX_FLAGS} -Werror=vla -Wno-missing-braces -Wno-null-pointer-subtraction")
endif()

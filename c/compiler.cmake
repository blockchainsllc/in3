if(MSVC)
  ...
  set (CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fPIC -Wall -funsigned-char -Wextra -std=c99 -Wpointer-arith¶")
...
if (WASM)
  set (CMAKE_C_FLAGS "-Wall  -Wno-unknown-warning-option -Wpointer-arith -funsigned-char -Wextra -std=c99 -Wno-unused-function -Wno-null-pointer-arithmetic")
  set (CMAKE_CXX_FLAGS "-Wall  -Wno-unknown-warning-option -Wpointer-arith -funsigned-char -Wextra  -std=c99 -Wno-unused-function -Wno-null-pointer-arithmetic -D__FILENAME__='\"$(subst ${CMAKE_SOURCE_DIR}/,,$(abspath $<))\"'")

...
static void test_verify_eth_getLog_filter_default() {
  ...
  TEST_ASSERT_TRUE(matches_filter(jreq->result, addrs, 0x793426, blkhash, jtopics->result));
  free(blkhash.data);
  free(addrs.data);
  json_free(jtopics);
  json_free(jreq);
...
static void test_verify_eth_getLog_filter_address() {
  ...
  bytes_t     addrs   = hexstrtobin("0x8912358d977e123b51ecad1ffa0cc4a7e32ff774");
  bytes_t     blkhash = hexstrtobin("0x6936d98945a4dec4c4c98052f429435f7f8ae45ea02f9503a67ae296014bef27");
  TEST_ASSERT_FALSE(matches_filter(jreq->result, addrs, 0x793426, blkhash, jtopics->result));
  json_free(jreq);
...
static void test_verify_eth_getLog_filter_range() {
  ...
  bytes_t     blkhash = hexstrtobin("0x6936d98945a4dec4c4c98052f429435f7f8ae45ea02f9503a67ae296014bef27");
  TEST_ASSERT_TRUE(matches_filter(jreq->result, addrs, 0x793426, blkhash, jtopics->result));
  TEST_ASSERT_FALSE(matches_filter(jreq->result, addrs, 0x793421, blkhash, jtopics->result));
  TEST_ASSERT_TRUE(matches_filter(jreq->result, addrs, 0x793422, blkhash, jtopics->result));
  TEST_ASSERT_TRUE(matches_filter(jreq->result, addrs, 0x793489, blkhash, jtopics->result));
  TEST_ASSERT_FALSE(matches_filter(jreq->result, addrs, 0x793491, blkhash, jtopics->result));
  TEST_ASSERT_TRUE(matches_filter(jreq->result, addrs, 0x793490, blkhash, jtopics->result));
  free(blkhash.data);
  free(addrs.data);
  json_free(jtopics);
  json_free(jreq);

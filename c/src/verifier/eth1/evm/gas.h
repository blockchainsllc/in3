    ...
    if (res == 0) {                                                                                        \
      if (parent->gas < gas) {                                                                             \
        if (parent->gas + gas_call_value < gas) {                                                          \
          ...
          /* the call depens on how much gas will be refunded after execution. */                          \
          /* We take an optimistic approach, set the flag and proceed ith execution*/                      \
          depend_on_refund_gas = true;                                                                     \
        }                                                                                                  \
      }                                                                                                    \
      else                                                                                                 \
        parent->gas -= gas;                                                                                \

...
NONULL in3_nodeselect_wrapper_t* in3_get_nodelist(in3_t* c);
...
node_match_t* in3_node_list_fill_weight(in3_t* c, in3_nodeselect_wrapper_t* w, in3_node_t* all_nodes, in3_node_weight_t* weights, unsigned int len, uint64_t now, uint32_t* total_weight, unsigned int* total_found, const in3_node_filter_t* filter, bytes_t* pre_filter);

...
sb_t*        sb_add_raw_bytes(sb_t* sb, const char* prefix, const bytes_t* bytes, int len, bool as_array); /**< add bytes as hexcoded string (including an optional prefix), if len>1 is passed bytes maybe an array ( if as_array==true)  */

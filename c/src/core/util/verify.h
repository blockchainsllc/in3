...
#ifndef __cplusplus
#if (201112L <= __STDC_VERSION__ || (!defined __STRICT_ANSI__ && 4 < __GNUC__ + (6 <= __GNUC_MINOR__)))
#define _GL_HAVE__STATIC_ASSERT 1
#endif
#if (202000L <= __STDC_VERSION__ || (!defined __STRICT_ANSI__ && 9 <= __GNUC__))
...
#define _GL_VERIFY_TYPE(R, DIAGNOSTIC)                        \
  struct {                                                    \
    unsigned int _gl_verify_error_if_negative : (R) ? 1 : -1; \
  }
#endif
...
#if (__has_builtin(__builtin_unreachable) || 4 < __GNUC__ + (5 <= __GNUC_MINOR__))
#define assume(R) ((R) ? (void) 0 : __builtin_unreachable())
#elif 1200 <= _MSC_VER
#define assume(R) __assume(R)
#elif ((defined GCC_LINT || defined lint) && (__has_builtin(__builtin_trap) || 3 < __GNUC__ + (3 < __GNUC_MINOR__ + (4 <= __GNUC_PATCHLEVEL__))))

...
#define R_SELFDESTRUCT 0    // This is the refund given (added into the refund counter) for self-destructing an account.
#define G_SELFDESTRUCT 0    // This is the amount of gas to pay for a SELFDESTRUCT operation.

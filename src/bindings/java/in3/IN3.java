...
/**
 * This is the main class creating the incubed client. The client can then be configured.
 *
 */
public class IN3 {  
    ...
    /** sets min stake of the server. Only nodes owning at least this amount will be chosen. */
    ...
    /** send a request but returns a object like array or map with the parsed response. The request must a valid json-string with method and params */
    ...
    /** send a RPC request by only passing the method and params. It will create the raw request from it and return the result.*/

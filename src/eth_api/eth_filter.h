...
size_t            eth_newBlockFilter(in3_t* in3, in3_filter_opt_t* options);                               /**< creates a new block filter with specified options and returns its id (>0) on success or 0 on failure */
size_t            eth_newPendingTransactionFilter(in3_t* in3, in3_filter_opt_t* options);                  /**< creates a new pending txn filter with specified options and returns its id on success or 0 on failure */

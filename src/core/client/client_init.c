...
static void in3_client_init(in3_t* c) {
  ...
  // local
  initChain(c->chains + 5, 0xFFFF, "f0fb87f4757c77ea3416afe87f36acaa0496c7e9", 1, CHAIN_ETH, NULL);
  initNode(c->chains + 5, 0, "784bfa9eb182c3a02dbeb5285e3dba92d717e07a", "http://localhost:8545");
}
